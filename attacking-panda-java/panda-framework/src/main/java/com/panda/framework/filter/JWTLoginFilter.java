package com.panda.framework.filter;

import cn.hutool.json.JSONUtil;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.panda.common.constant.ConstantKey;
import com.panda.common.result.ApiResult;
import com.panda.framework.filter.dto.UserDTO;
...
public class JWTLoginFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request,
        ...
        try {
            ...
            ApiResult result = ApiResult.ok(resultMap);
